...
router.post('/cobroFallidoMP', async (req, res) => {
  ...
  console.log("entro al cobro cobroFallidoMP de MP req.params", req.params)
  console.log("entro al cobro cobroFallidoMP de MP req.body", req.body)
  res.send("Hola mundo Fallo");
  return
});
